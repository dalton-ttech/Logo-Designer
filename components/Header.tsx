...
export const Header: React.FC = () => {
  return (
    <header className="fixed top-0 left-0 w-full z-40 px-4 py-3 md:px-8 md:py-4 flex items-center justify-between bg-black/20 backdrop-blur-xl border-b border-white/5 shadow-sm transition-all">
      <div className="flex items-center gap-2 group cursor-default">
        ...
        <span className="inline-block w-2 h-4 md:h-5 bg-slate-100/50 animate-pulse ml-0.5 rounded-sm" />
      </div>
